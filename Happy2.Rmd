...
The report examine the state of happiness in today’s world to demonstrate how personal and national differences in happiness are understood by the new science of happiness.
...
### Generosity 
It shows that Generosity is not a strong factor for overall happiness ranking.
...
### GDP per Capital
It shows that GDP is a strong factor for overall happiness ranking.
...
It shows that social support is not a strong factor for overall happiness ranking.
```{r}
